<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>@yield('title', $websiteSettings?->school_name ?: 'C-Net Pathshala')</title>
<meta name="description" content="@yield('meta_description', ($websiteSettings?->school_name ?: 'C-Net Pathshala') . ' - Quality education in Bihar Sharif, Nalanda.')">
<link rel="canonical" href="@yield('canonical_url', url()->current())">
<meta property="og:type" content="website">
<meta property="og:title" content="@yield('og_title', $websiteSettings?->school_name ?: 'C-Net Pathshala')">
<meta property="og:description" content="@yield('og_description', ($websiteSettings?->school_name ?: 'C-Net Pathshala') . ' - Quality education in Bihar Sharif, Nalanda.')">
<meta property="og:url" content="@yield('canonical_url', url()->current())">
<meta property="og:image" content="@yield('og_image', asset('images/logo.png'))">
<meta property="og:site_name" content="{{ $websiteSettings?->school_name ?: 'C-Net Pathshala' }}">
